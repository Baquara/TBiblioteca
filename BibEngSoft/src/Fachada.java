...
livro.registerObserver(observador);
		...
		if(usuarioencontrado!=null) {
			if(livroencontrado!=null) {
						...
						if(usuarioencontrado.podeEmprestar()==true) {
							...
							usuarioencontrado.realizarEmprestimo(livroencontrado);
	...
	public java.lang.String consultarUsuario(String codigoUsuario) {
		...
		if(usuarioencontrado!=null) {
							...
							" " + usuarioencontrado.getEmprestimosPassados() + " " + usuarioencontrado.getReservas() + " " + usuarioencontrado.estaDevedor();
							return resultado;
